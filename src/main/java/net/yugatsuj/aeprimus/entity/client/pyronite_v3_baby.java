...
public class pyronite_v3_baby<T extends Entity> extends HierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "pyronite_v3_baby"), "main");
    private final ModelPart pyronite_v3_baby;
    ...
    public pyronite_v3_baby(ModelPart root) {
        this.pyronite_v3_baby = root.getChild("pyronite_v3_baby");
        this.WholeBody = this.pyronite_v3_baby.getChild("WholeBody");
        ...
        this.WholeHead = this.pyronite_v3_baby.getChild("WholeHead");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition pyronite_v3_baby = partdefinition.addOrReplaceChild("pyronite_v3_baby", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition WholeBody = pyronite_v3_baby.addOrReplaceChild("WholeBody", CubeListBuilder.create(), PartPose.offset(0.0F, -27.0F, 0.225F));
        ...
        PartDefinition chest2 = armorBodyHat.addOrReplaceChild("chest2", CubeListBuilder.create().texOffs(93, 99).addBox(-3.61F, 1.7163F, -3.5606F, 7.0F, 8.0F, 6.0F, new CubeDeformation(-0.45F)), PartPose.offsetAndRotation(0.0F, 2.2456F, 1.1231F, 0.0436F, 0.0F, 0.0F));

        PartDefinition neck2 = armorBodyHat.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.135F, -1.636F, 0.8682F, 0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition chest = body.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(94, 77).addBox(-3.615F, 1.9861F, -2.9265F, 7.0F, 8.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 1.9956F, 1.1231F, 0.0436F, 0.0F, 0.0F));

        PartDefinition neck = body.addOrReplaceChild("neck", CubeListBuilder.create(), PartPose.offsetAndRotation(0.135F, -1.93F, 0.99F, 0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition leftleg_upper = leftleg_r.addOrReplaceChild("leftleg_upper", CubeListBuilder.create(), PartPose.offset(1.0F, 7.5F, 0.0F));
        ...
        PartDefinition leftleg_upper_r1 = leftleg_upper.addOrReplaceChild("leftleg_upper_r1", CubeListBuilder.create().texOffs(30, 73).addBox(2.8319F, -11.8365F, -1.9175F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(72, 68).addBox(2.8019F, -11.8065F, -1.9475F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-3.4096F, 11.3445F, -1.166F, -0.096F, -0.0873F, -0.0873F));

        PartDefinition leftleg_lower = leftleg_upper.addOrReplaceChild("leftleg_lower", CubeListBuilder.create().texOffs(0, 75).addBox(-1.6205F, -0.7147F, -0.7212F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(76, 27).addBox(-1.6155F, -0.7447F, -0.7412F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.5F))
                .texOffs(30, 55).addBox(-1.1805F, 0.6703F, -0.2812F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.5755F, 5.4075F, -1.486F, -0.0037F, -0.0858F, -0.0759F));

        PartDefinition armorLeftLeg_r1 = leftleg_lower.addOrReplaceChild("armorLeftLeg_r1", CubeListBuilder.create().texOffs(52, 7).addBox(1.7182F, 20.2746F, 0.436F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.9191F, -16.5371F, 1.3179F, -0.0349F, 0.0F, 0.0716F));

        PartDefinition armorLeftLeg_r2 = leftleg_lower.addOrReplaceChild("armorLeftLeg_r2", CubeListBuilder.create().texOffs(72, 54).addBox(1.011F, -1.8182F, -4.0613F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.7807F, 5.4814F, 1.0466F, -0.0349F, 0.0F, 0.0716F));
        ...
        PartDefinition rightleg_lower = rightleg_upper.addOrReplaceChild("rightleg_lower", CubeListBuilder.create().texOffs(76, 34).addBox(-1.3993F, -0.7865F, -0.4733F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(76, 41).addBox(-1.3793F, -0.8165F, -0.4933F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.5F))
                .texOffs(30, 62).addBox(-0.9393F, 0.5985F, 0.0667F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.5755F, 5.9075F, -1.764F, -0.0037F, 0.0858F, 0.0759F));

        PartDefinition armorRightLeg_r1 = rightleg_lower.addOrReplaceChild("armorRightLeg_r1", CubeListBuilder.create().texOffs(12, 63).addBox(-2.7182F, 20.2746F, 0.436F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.7992F, -16.6089F, 1.6657F, -0.0349F, 0.0F, -0.0716F));

        PartDefinition armorRightLeg_r2 = rightleg_lower.addOrReplaceChild("armorRightLeg_r2", CubeListBuilder.create().texOffs(72, 61).addBox(-4.011F, -1.8182F, -4.0613F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.6608F, 5.4096F, 1.3944F, -0.0349F, 0.0F, -0.0716F));

        PartDefinition LeftArm = WholeBody.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offsetAndRotation(2.55F, 7.025F, 1.35F, 0.0F, 0.0F, -0.0436F));
        ...
        PartDefinition RightArm = WholeBody.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.55F, 7.025F, 1.35F, 0.0F, 0.0F, 0.0436F));
        ...
        PartDefinition WholeHead = pyronite_v3_baby.addOrReplaceChild("WholeHead", CubeListBuilder.create(), PartPose.offset(-0.25F, -23.25F, 0.675F));
        ...
        PartDefinition flames = WholeHead.addOrReplaceChild("flames", CubeListBuilder.create(), PartPose.offsetAndRotation(0.25F, -3.4109F, -1.5881F, 0.1309F, 0.0F, 0.0F));
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        pyronite_v3_baby.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }

    @Override
    public ModelPart root() {
        return pyronite_v3_baby;
    }
}