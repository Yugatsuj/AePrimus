...
public class pyronite_v2_baby<T extends Entity> extends HierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "pyronite_v2_baby"), "main");
    private final ModelPart pyronite_v2_baby;
    ...
    public pyronite_v2_baby(ModelPart root) {
        this.pyronite_v2_baby = root.getChild("pyronite_v2_baby");
        this.WholeBody = this.pyronite_v2_baby.getChild("WholeBody");
        ...
        this.WholeHead = this.pyronite_v2_baby.getChild("WholeHead");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition pyronite_v2_baby = partdefinition.addOrReplaceChild("pyronite_v2_baby", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition WholeBody = pyronite_v2_baby.addOrReplaceChild("WholeBody", CubeListBuilder.create(), PartPose.offset(0.0F, -18.0F, 0.225F));

        PartDefinition body = WholeBody.addOrReplaceChild("body", CubeListBuilder.create().texOffs(76, 21).addBox(-2.04F, 6.2F, -0.9775F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.15F))
                .texOffs(24, 23).addBox(-3.59F, 1.9F, -1.4025F, 7.0F, 5.0F, 5.0F, new CubeDeformation(-0.15F)), PartPose.offset(0.0F, 0.25F, 0.0F));

        PartDefinition armorBodyHat = body.addOrReplaceChild("armorBodyHat", CubeListBuilder.create().texOffs(74, 0).addBox(-2.0325F, 16.3525F, -0.935F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F))
                .texOffs(0, 25).addBox(-3.61F, 11.88F, -1.4325F, 7.0F, 5.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, -10.0F, 0.0F));

        PartDefinition chest2 = armorBodyHat.addOrReplaceChild("chest2", CubeListBuilder.create().texOffs(24, 0).addBox(-4.11F, 3.9661F, -3.5715F, 8.0F, 6.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 2.2456F, 1.1231F, 0.0436F, 0.0F, 0.0F));

        PartDefinition neck2 = armorBodyHat.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.135F, -0.036F, 0.8682F, 0.3927F, 0.0F, 0.0F));

        PartDefinition neck2_r1 = neck2.addOrReplaceChild("neck2_r1", CubeListBuilder.create().texOffs(52, 0).addBox(-3.1F, 5.9859F, -3.3851F, 6.0F, 2.0F, 5.0F, new CubeDeformation(-0.45F)), PartPose.offsetAndRotation(-0.135F, -0.8829F, 0.4613F, -0.3054F, 0.0F, 0.0F));

        PartDefinition chest = body.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(24, 12).addBox(-4.115F, 4.2358F, -2.9374F, 8.0F, 6.0F, 5.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -8.0044F, 1.1231F, 0.0436F, 0.0F, 0.0F));

        PartDefinition neck = body.addOrReplaceChild("neck", CubeListBuilder.create(), PartPose.offsetAndRotation(0.135F, -10.33F, 0.99F, 0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition LeftLeg = WholeBody.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(0.785F, 3.15F, 1.125F));
        ...
        PartDefinition leftleg_lower = leftleg_upper.addOrReplaceChild("leftleg_lower", CubeListBuilder.create().texOffs(0, 75).addBox(-1.3722F, -0.6957F, -0.7425F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(76, 27).addBox(-1.3672F, -0.7257F, -0.7625F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.5F))
                .texOffs(30, 55).addBox(-0.9322F, 0.6893F, -0.3024F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.3255F, 5.1575F, -1.236F, -0.0037F, -0.0858F, -0.0759F));

        PartDefinition armorLeftLeg_r1 = leftleg_lower.addOrReplaceChild("armorLeftLeg_r1", CubeListBuilder.create().texOffs(52, 7).addBox(1.7182F, 20.2746F, 0.436F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.6707F, -16.5181F, 1.2966F, -0.0349F, 0.0F, 0.0716F));

        PartDefinition armorLeftLeg_r2 = leftleg_lower.addOrReplaceChild("armorLeftLeg_r2", CubeListBuilder.create().texOffs(72, 54).addBox(1.011F, -1.8182F, -4.0613F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.5323F, 5.5004F, 1.0253F, -0.0349F, 0.0F, 0.0716F));

        PartDefinition RightLeg = WholeBody.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-0.785F, 3.15F, 1.125F));
        ...
        PartDefinition rightleg_upper = rightleg_r.addOrReplaceChild("rightleg_upper", CubeListBuilder.create(), PartPose.offset(-1.0F, 7.5F, -0.25F));
        ...
        PartDefinition rightleg_upper_r1 = rightleg_upper.addOrReplaceChild("rightleg_upper_r1", CubeListBuilder.create().texOffs(12, 74).addBox(-5.8319F, -11.7865F, -1.9175F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(42, 73).addBox(-5.8019F, -11.7565F, -1.9475F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(3.4096F, 11.3445F, -0.916F, -0.096F, 0.0873F, 0.0873F));

        PartDefinition rightleg_lower = rightleg_upper.addOrReplaceChild("rightleg_lower", CubeListBuilder.create().texOffs(76, 34).addBox(-1.6288F, -0.5182F, -0.492F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.55F))
                .texOffs(76, 41).addBox(-1.6088F, -0.5482F, -0.512F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.5F))
                .texOffs(30, 62).addBox(-1.1688F, 0.8668F, 0.048F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.3255F, 5.1575F, -1.514F, -0.0037F, 0.0858F, 0.0759F));

        PartDefinition armorRightLeg_r1 = rightleg_lower.addOrReplaceChild("armorRightLeg_r1", CubeListBuilder.create().texOffs(12, 63).addBox(-2.7182F, 20.2746F, 0.436F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.5697F, -16.3406F, 1.647F, -0.0349F, 0.0F, -0.0716F));

        PartDefinition armorRightLeg_r2 = rightleg_lower.addOrReplaceChild("armorRightLeg_r2", CubeListBuilder.create().texOffs(72, 61).addBox(-4.011F, -1.8183F, -4.0613F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.4313F, 5.6779F, 1.3757F, -0.0349F, 0.0F, -0.0716F));

        PartDefinition LeftArm = WholeBody.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offsetAndRotation(3.05F, -1.725F, 1.35F, 0.0F, 0.0F, -0.0436F));
        ...
        PartDefinition RightArm = WholeBody.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.05F, -1.725F, 1.35F, 0.0F, 0.0F, 0.0436F));
        ...
        PartDefinition WholeHead = pyronite_v2_baby.addOrReplaceChild("WholeHead", CubeListBuilder.create(), PartPose.offset(-0.25F, -22.25F, 0.675F));
        ...
        PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(60, 44).addBox(-1.9212F, -2.9668F, -1.9212F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.5F))
                .texOffs(60, 21).addBox(-1.8999F, -3.5149F, -1.8999F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -0.2531F, 3.0146F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition mask_r1 = mask.addOrReplaceChild("mask_r1", CubeListBuilder.create().texOffs(97, 50).mirror().addBox(-3.565F, -2.9007F, -1.2875F, 5.0F, 5.0F, 0.0F, new CubeDeformation(-0.5F)).mirror(false)
                .texOffs(93, 35).mirror().addBox(-3.1399F, -3.1507F, -1.0375F, 4.0F, 5.0F, 0.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.6163F, -0.8031F, 0.0F, 0.5236F, 0.0F));
        ...
        PartDefinition mask_r2 = mask.addOrReplaceChild("mask_r2", CubeListBuilder.create().texOffs(97, 50).addBox(-1.4326F, -2.8985F, -1.2909F, 5.0F, 5.0F, 0.0F, new CubeDeformation(-0.5F))
                .texOffs(95, 40).addBox(-0.8576F, -3.1485F, -1.0409F, 4.0F, 5.0F, 0.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.6163F, -0.8031F, 0.0F, -0.5236F, 0.0F));

        PartDefinition jaw = mask.addOrReplaceChild("jaw", CubeListBuilder.create(), PartPose.offset(0.0F, 2.6447F, -1.0407F));

        PartDefinition jaw_r1 = jaw.addOrReplaceChild("jaw_r1", CubeListBuilder.create().texOffs(2, 1).addBox(0.0017F, -4.7066F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 4.1699F, -0.2317F, 0.0F, -0.5236F, 0.0F));

        PartDefinition jaw_r2 = jaw.addOrReplaceChild("jaw_r2", CubeListBuilder.create().texOffs(6, 1).addBox(-1.0F, -4.7066F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 4.1699F, -0.2317F, 0.0F, 0.5236F, 0.0F));
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        pyronite_v2_baby.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }

    @Override
    public ModelPart root() {
        return pyronite_v2_baby;
    }
}