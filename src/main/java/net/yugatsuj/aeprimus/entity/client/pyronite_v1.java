...
public class pyronite_v1<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "pyronite_v1"), "main");
    private final ModelPart pyronite_v1;
    ...
    public pyronite_v1(ModelPart root) {
        this.pyronite_v1 = root.getChild("pyronite_v1");
        this.WholeBody = this.pyronite_v1.getChild("WholeBody");
        ...
        this.WholeHead = this.pyronite_v1.getChild("WholeHead");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition pyronite_v1 = partdefinition.addOrReplaceChild("pyronite_v1", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition WholeBody = pyronite_v1.addOrReplaceChild("WholeBody", CubeListBuilder.create(), PartPose.offset(0.0F, -27.0F, 0.225F));
        ...
        PartDefinition body = WholeBody.addOrReplaceChild("body", CubeListBuilder.create().texOffs(76, 21).addBox(-2.04F, 10.7F, -0.9775F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F))
                .texOffs(24, 23).addBox(-3.59F, 5.9F, -1.4025F, 7.0F, 5.0F, 5.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition armorBodyHat = body.addOrReplaceChild("armorBodyHat", CubeListBuilder.create().texOffs(74, 0).addBox(-2.0325F, 10.8525F, -0.935F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.075F))
                .texOffs(0, 25).addBox(-3.61F, 5.88F, -1.4325F, 7.0F, 5.0F, 5.0F, new CubeDeformation(-0.1F))
                .texOffs(187, 34).addBox(-3.61F, 10.68F, -1.2325F, 7.0F, 5.0F, 0.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition chest2 = armorBodyHat.addOrReplaceChild("chest2", CubeListBuilder.create().texOffs(24, 0).addBox(-4.11F, -2.278F, -3.2989F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 2.2456F, 1.1231F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition chest = body.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(24, 12).addBox(-4.115F, -2.0082F, -2.6648F, 8.0F, 6.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 1.9956F, 1.1231F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition leftleg_upper_r1 = leftleg_upper.addOrReplaceChild("leftleg_upper_r1", CubeListBuilder.create().texOffs(30, 73).addBox(3.1036F, -15.8188F, -2.0966F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(72, 68).addBox(3.0736F, -15.9888F, -2.1265F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-2.4096F, 18.8445F, -1.166F, -0.096F, -0.0873F, -0.0873F));
        ...
        PartDefinition rightleg_upper_r1 = rightleg_upper.addOrReplaceChild("rightleg_upper_r1", CubeListBuilder.create().texOffs(12, 74).addBox(-6.1036F, -15.8188F, -2.0966F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(42, 73).addBox(-6.0736F, -15.9888F, -2.1265F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(2.4096F, 18.8445F, -1.166F, -0.096F, 0.0873F, 0.0873F));
        ...
        PartDefinition LeftArm = WholeBody.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offsetAndRotation(4.05F, 2.025F, 1.35F, 0.0F, 0.0F, -0.0436F));
        ...
        PartDefinition RightArm = WholeBody.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.05F, 2.025F, 1.35F, 0.0F, 0.0F, 0.0436F));
        ...
        PartDefinition WholeHead = pyronite_v1.addOrReplaceChild("WholeHead", CubeListBuilder.create(), PartPose.offset(0.0F, -29.25F, 0.675F));
        ...
        PartDefinition mask_r2 = mask.addOrReplaceChild("mask_r2", CubeListBuilder.create().texOffs(190, 6).mirror().addBox(-3.1399F, -3.1507F, -1.0375F, 4.0F, 5.0F, 0.0F, new CubeDeformation(-0.6F)).mirror(false), PartPose.offsetAndRotation(0.0F, -1.9587F, -1.1031F, 0.0F, 0.5236F, 0.0F));

        PartDefinition mask_r3 = mask.addOrReplaceChild("mask_r3", CubeListBuilder.create().texOffs(192, 11).addBox(-0.8576F, -3.1485F, -1.0409F, 4.0F, 5.0F, 0.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, -1.9587F, -1.1031F, 0.0F, -0.5236F, 0.0F));

        PartDefinition mask_r4 = mask.addOrReplaceChild("mask_r4", CubeListBuilder.create().texOffs(97, 50).addBox(-1.4326F, -2.8985F, -1.2909F, 5.0F, 5.0F, 0.0F, new CubeDeformation(-0.8F))
