...
public class PyroniteBabyV1AnimationDefinitions {
    public static final AnimationDefinition BABY_PYRONITE_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition BABY_PYRONITE_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
            ...
            .addAnimation("pyronite_v1_baby", new AnimationChannel(AnimationChannel.Targets.POSITION,
