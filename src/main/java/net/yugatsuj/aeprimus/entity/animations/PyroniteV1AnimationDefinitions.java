...
public class PyroniteV1AnimationDefinitions {
    public static final AnimationDefinition PYRONITE_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
            ...
            .addAnimation("pyronite_v1", new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition PYRONITE_OFFER = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("leftarm_upper", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-44.5687F, 6.4086F, 7.6926F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("rightarm_upper", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-44.3247F, -7.9972F, -9.6385F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}