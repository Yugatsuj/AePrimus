...
public class pyroniteMerchantOffers {
    ...
    public static final Map<VillagerProfession, Int2ObjectMap<ItemListing[]>> PROFESSION_TO_LEVELED_TRADE = Util.make(Maps.newHashMap(), map -> {
        map.put(VillagerProfession.FARMER, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYRONITEPEBBLES.get(), 20, 20, 5), new BuyForOneEmeraldFactory(Items.GLOW_BERRIES, 22, 16, 3), new SellItemFactory(Items.BREAD, 1, 6, 16, 1)}, 2, new ItemListing[]{new SellItemFactory(Items.PUMPKIN_PIE, 1, 4, 5), new SellItemFactory(Items.GOLDEN_APPLE, 8, 1, 8, 20)}, 3, new ItemListing[]{new SellItemFactory(Items.COOKIE, 3, 18, 10), new BuyForOneEmeraldFactory(Blocks.MELON, 4, 12, 20)}, 4, new ItemListing[]{new SellItemFactory(Blocks.CAKE, 1, 1, 12, 15), new BuyForOneEmeraldFactory(Items.DIRT, 63, 16, 2)},
                5, new ItemListing[]{new SellItemFactory(Items.GOLDEN_CARROT, 3, 3, 30), new SellItemFactory(Items.GLISTERING_MELON_SLICE, 4, 3, 30)})));
        map.put(VillagerProfession.FISHERMAN, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYRONITEPEBBLES.get(), 20, 20, 5), new BuyForOneEmeraldFactory(Items.STRING, 20, 16, 2), new BuyForOneEmeraldFactory(Items.COAL, 10, 16, 2), new ProcessItemFactory(Items.COD, 6, Items.COOKED_COD, 6, 16, 1),}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(Items.COD, 15, 16, 10), new ProcessItemFactory(Items.SALMON, 6, Items.COOKED_SALMON, 6, 16, 5), new SellItemFactory(Items.SOUL_CAMPFIRE, 2, 1, 5)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(Items.SALMON, 13, 16, 20), new SellEnchantedToolFactory(Items.FISHING_ROD, 3, 3, 10, 0.2f)}, 4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.TROPICAL_FISH, 6, 12, 30)}, 5, new ItemListing[]{new BuyForOneEmeraldFactory(Items.PUFFERFISH, 4, 12, 30), new SellItemFactory(new ItemStack(Items.WATER_BUCKET), 8, 1, 2, 9, 0.2f), new SellItemFactory(new ItemStack(Items.ICE), 4, 1, 8, 9, 0.2f)})));
        map.put(VillagerProfession.SHEPHERD,
                copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(Blocks.WHITE_WOOL, 18, 16, 2), new BuyForOneEmeraldFactory(Blocks.BROWN_WOOL, 18, 16, 2), new BuyForOneEmeraldFactory(Blocks.BLACK_WOOL, 18, 16, 2), new BuyForOneEmeraldFactory(Blocks.GRAY_WOOL, 18, 16, 2), new SellItemFactory(Items.SHEARS, 2, 1, 1)}, 2,
                        ...
                        4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.BROWN_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.PURPLE_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.BLUE_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.GREEN_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.MAGENTA_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.CYAN_DYE, 12, 16, 30), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25),
                                new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25)},
                        5, new ItemListing[]{new SellItemFactory(ModItems.PYROSIANASH.get(), 64, 1, 2, 50)})));
        map.put(VillagerProfession.FLETCHER, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 8, 16, 6), new SellItemFactory(Items.ARROW, 1, 16, 1), new ProcessItemFactory(Blocks.GRAVEL, 10, Items.FLINT, 10, 12, 1)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(Items.FLINT, 26, 12, 10), new SellItemFactory(Items.BOW, 2, 1, 5)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(Items.STRING, 14, 16, 20), new SellItemFactory(Items.CROSSBOW, 3, 1, 10)}, 4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.FEATHER, 24, 16, 30), new SellEnchantedToolFactory(Items.BOW, 2, 3, 15)}, 5, new ItemListing[]{new BuyForOneEmeraldFactory(Items.TRIPWIRE_HOOK, 8, 12, 30), new SellEnchantedToolFactory(Items.CROSSBOW, 3, 3, 15), new SellPotionHoldingItemFactory(Items.ARROW, 5, Items.TIPPED_ARROW, 5, 2, 12, 30)})));
        ...
        map.put(VillagerProfession.CARTOGRAPHER,
                copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(Items.PAPER, 24, 16, 2), new SellItemFactory(Items.MAP, 7, 1, 1)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(Items.GLASS_PANE, 11, 16, 10)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(Items.COMPASS, 1, 12, 20),}, 4,
                        new ItemListing[]{new SellItemFactory(Items.ITEM_FRAME, 7, 1, 15), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25), new SellItemFactory(ModItems.PYROSIANASH.get(), 3, 1, 12, 25)}, 5,
                        new ItemListing[]{new SellItemFactory(Items.GLOBE_BANNER_PATTERN, 6, 1, 45)})));
        map.put(VillagerProfession.CLERIC, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(Items.ROTTEN_FLESH, 32, 16, 2)})));
        map.put(VillagerProfession.ARMORER, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 12, 16, 2), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 14, 1, 12, 4, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 8, 1, 12, 4, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 10, 1, 12, 4, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 36, 1, 12, 8, 0.2f)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 4, 8, 10), new SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 8, 1, 12, 4, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 14, 1, 12, 4, 0.2f)}, 3,
                new ItemListing[]{new BuyForOneEmeraldFactory(Items.LAVA_BUCKET, 1, 12, 20), new BuyForOneEmeraldFactory(Items.DIAMOND, 1, 12, 20), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 10, 1, 12, 4, 0.2f), new SellItemFactory(new ItemStack(ModItems.PYROSIANASH.get()), 36, 1, 12, 8, 0.2f), new SellItemFactory(new ItemStack(Items.SHIELD), 5, 1, 12, 10, 0.2f)}, 4, new ItemListing[]{new SellEnchantedToolFactory(ModItems.PYROSIANASH.get(), 28, 3, 15, 0.2f), new SellEnchantedToolFactory(ModItems.PYROSIANASH.get(), 16, 3, 15, 0.2f)}, 5, new ItemListing[]{new SellEnchantedToolFactory(ModItems.PYROSIANASH.get(), 16, 3, 30, 0.2f), new SellEnchantedToolFactory(ModItems.PYROSIANASH.get(), 48, 3, 30, 0.2f)})));
        map.put(VillagerProfession.WEAPONSMITH,
                copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 12, 16, 2), new SellItemFactory(new ItemStack(Items.IRON_AXE), 3, 1, 12, 1, 0.2f), new SellEnchantedToolFactory(Items.IRON_SWORD, 2, 3, 1)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 4, 12, 10), new SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2f)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(Items.FLINT, 24, 12, 20)}, 4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.DIAMOND, 1, 12, 30), new SellEnchantedToolFactory(Items.DIAMOND_AXE, 12, 3, 15, 0.2f)}, 5, new ItemListing[]{new SellEnchantedToolFactory(Items.DIAMOND_SWORD, 8, 3, 30, 0.2f)})));
        map.put(VillagerProfession.TOOLSMITH, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 12, 16, 2), new SellItemFactory(new ItemStack(Items.SOUL_TORCH), 3, 16, 8, 1, 0.2f), new SellItemFactory(ModItems.PYROSIANASH.get(), 14, 1, 2, 2), new SellItemFactory(new ItemStack(Items.STONE_AXE), 1, 1, 12, 1, 0.2f), new SellItemFactory(new ItemStack(Items.STONE_SHOVEL), 1, 1, 12, 1, 0.2f), new SellItemFactory(new ItemStack(Items.STONE_HOE), 1, 1, 12, 1, 0.2f)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 4, 12, 10), new SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2f)}, 3,
                new ItemListing[]{new BuyForOneEmeraldFactory(Items.FLINT, 30, 12, 20), new SellEnchantedToolFactory(Items.IRON_AXE, 1, 3, 10, 0.2f), new SellEnchantedToolFactory(Items.IRON_SHOVEL, 2, 3, 10, 0.2f), new SellEnchantedToolFactory(Items.IRON_PICKAXE, 3, 3, 10, 0.2f), new SellItemFactory(new ItemStack(Items.DIAMOND_HOE), 4, 1, 3, 10, 0.2f)}, 4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.DIAMOND, 1, 12, 30), new SellEnchantedToolFactory(Items.DIAMOND_AXE, 12, 3, 15, 0.2f), new SellEnchantedToolFactory(Items.DIAMOND_SHOVEL, 5, 3, 15, 0.2f)}, 5, new ItemListing[]{new SellEnchantedToolFactory(Items.DIAMOND_PICKAXE, 13, 3, 30, 0.2f),  new SellItemFactory(ModItems.PYROSIANASH.get(), 32, 1, 1, 60)})));
        map.put(VillagerProfession.BUTCHER, copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYRONITEPEBBLES.get(), 20, 20, 5), new BuyForOneEmeraldFactory(Items.CHICKEN, 14, 16, 2), new BuyForOneEmeraldFactory(Items.PORKCHOP, 7, 16, 2), new BuyForOneEmeraldFactory(Items.RABBIT, 4, 16, 2), new SellItemFactory(Items.RABBIT_STEW, 1, 1, 1)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(Items.COAL, 15, 16, 2), new SellItemFactory(Items.COOKED_PORKCHOP, 1, 5, 16, 5), new SellItemFactory(Items.COOKED_CHICKEN, 1, 8, 16, 5)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(Items.MUTTON, 7, 16, 20), new BuyForOneEmeraldFactory(Items.BEEF, 10, 16, 20)}, 4, new ItemListing[]{new BuyForOneEmeraldFactory(Items.DRIED_KELP_BLOCK, 10, 12, 30)}, 5, new ItemListing[]{new BuyForOneEmeraldFactory(Items.SWEET_BERRIES, 10, 12, 30)})));
        ...
        map.put(VillagerProfession.MASON,
                copyToFastUtilMap(Map.of(1, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 10, 16, 2), new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 32, 32, 1), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 10, 16, 1)}, 2, new ItemListing[]{new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 20, 16, 10), new SellItemFactory(ModBlocks.CHISLED_PYROSIAN_STONE_BRICKS.get(), 1, 4, 16, 5)}, 3, new ItemListing[]{new BuyForOneEmeraldFactory(ModBlocks.PYROSIAN_DEEPSLATE_BRICKS.get(), 16, 16, 20), new BuyForOneEmeraldFactory(ModBlocks.PYROSIAN_STONE.get(), 16, 16, 20), new BuyForOneEmeraldFactory(ModItems.PYROSIANASH.get(), 16, 16, 20), new SellItemFactory(Blocks.DRIPSTONE_BLOCK, 1, 4, 16, 10), new SellItemFactory(ModBlocks.CHISLED_PYROSIAN_STONE_BRICKS.get(), 1, 4, 16, 10), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 4, 16, 10), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 4, 16, 10)}, 4,
                        ...
                        5, new ItemListing[]{new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 8, 12, 15), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 8, 12, 15), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 4, 12, 15), new SellItemFactory(ModItems.PYROSIANASH.get(), 1, 3, 12, 15), new SellItemFactory(Blocks.QUARTZ_PILLAR, 1, 1, 12, 30), new SellItemFactory(Blocks.QUARTZ_BLOCK, 1, 1, 12, 30)})));
    });

    public static final Int2ObjectMap<ItemListing[]> WANDERING_TRADER_TRADES = copyToFastUtilMap(Map.of(1, new ItemListing[]{new SellItemFactory(ModItems.PYRONITEPEBBLES.get(), 1, 3, 6, 1), new SellItemFactory(ModItems.PYROSIANASH.get(), 48, 1, 2, 2),  new SellItemFactory(Items.SOUL_TORCH, 1, 12, 12, 1), new SellItemFactory(Items.SOUL_CAMPFIRE, 3, 1, 4, 1), new SellItemFactory(ModBlocks.PYROSIAN_STONE_BRICKS.get(), 12, 1, 2, 2), new SellItemFactory(ModItems.PYRONITEPEBBLES.get(), 10, 1, 3, 2), new SellItemFactory(ModBlocks.PYROSIAN_DEEPSLATE.get(), 10, 1, 2, 1), new SellItemFactory(ModItems.PYROSIANASH.get(), 16, 1, 2, 1), new SellItemFactory(ModItems.PYROSIANASH.get(), 14, 1, 2, 1), new SellItemFactory(ModItems.PYROSIANASH.get(), 8, 1, 2, 1), new SellItemFactory(Items.COAL, 1, 5, 4, 1), new SellItemFactory(Items.COPPER_INGOT, 1, 4, 12, 1),
